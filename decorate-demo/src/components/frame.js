...
import {BrowserRouter, NavLink, Route, Switch, HashRouter} from "react-router-dom";
import {
    AppstoreFilled,
    BarsOutlined,
                            ...
                            <Layout style={{
                                ...
                                <Content className={"site-layout-background"}
                                    ...
                                    <Switch>
                                        ...
                                        <Route path={"/orders"} component={OrderDemo}></Route>
                                        <Route path={"/active"}></Route>
                                        <Route path={"/case"}></Route>
                                        <Route path={"/article"} component={Article}></Route>
                                        <Route path={"/info"} component={Company}></Route>
